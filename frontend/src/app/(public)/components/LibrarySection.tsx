  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top Tag */}
        <div className="mb-8 inline-flex items-center gap-2 bg-teal-100 text-[#4F777A] px-4 py-2 rounded-full text-sm font-medium">
          <svg
            className="w-4 h-4"
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        <div className="mb-16">
          <div className="max-w-4xl">
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              D Free Book là không gian tri thức mở, nơi mọi người có thể tiếp
              cận sách miễn phí và chia sẻ niềm đam mê đọc sách. Chúng tôi tin
              rằng tri thức thuộc về tất cả mọi người và không ai bị bỏ lại phía
              sau.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <span className="text-gray-700">
                  Thời gian mở cửa: 8h30 – 22h mỗi ngày.
                </span>
              </div>
              <div className="flex items-start gap-3">
                <svg
                ...
                <span className="text-gray-700">
                  Địa chỉ: Số 107, khu tập thể A5, ngõ 128C Đại La.
                </span>
              </div>
              <div className="flex items-start gap-3">
                <svg
