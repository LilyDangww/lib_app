    ...
    const fetchCategories = async () => {
      try {
        ...
        const response = await fetch(
          `${API_BASE_URL}/documents/categories/public`,
          {
            method: "GET",
            headers: {
        ...
        // Keep empty array on error, will show "Tất cả" only
      } finally {
  ...
  return (
    <div className="mb-8">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        {loadingCategories ? (
          <div className="px-4 py-2 text-gray-500">Đang tải danh mục...</div>
        ) : (
      ...
      <button
        type="button"
        className="text-teal-600 border border-teal-500 bg-white px-4 py-2 rounded-lg hover:bg-teal-50 transition-colors"
      >
        Xem thêm
      </button>
    </div>
